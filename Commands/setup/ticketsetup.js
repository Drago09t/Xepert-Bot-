  ...
  async execute(interaction) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setThumbnail("https://media.discordapp.net/attachments/1084843388127432785/1091114146617110588/R__1_-removebg-preview.png")
        ...
        .setFooter({ text: "Support", iconURL: "https://media.discordapp.net/attachments/1084843388127432785/1091114146617110588/R__1_-removebg-preview.png" })
        .setColor("#235ee7");
