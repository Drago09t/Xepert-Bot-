...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("afk")
    .setDescription("💤 | Set yourself afk! (Away From Keyboard)")
    .addSubcommand(
      command =>
        command.setName("set")
    ...
    try {
      ...
      switch (options.getSubcommand()) {
        case "set": {
          ...
          Response.setColor("Red").setDescription(`Your AFK status has been updated to ${afkStatus}.`);
        ...
        case "return": {
          ...
          Response.setColor("Green").setDescription(`Your AFK status has been removed!`);
